---
title: "合作夥伴整合安全架構"
subtitle: "設計信任邊界與生產控制，涵蓋嵌入式交易、 API、 SDK、網路鉤、資產轉移及營運整合。"
...
合作夥伴前端應呼叫合作夥伴後端進行特權操作。後端會驗證合作夥伴使用者，透過核准的API或SDK呼叫6MM，並只回傳前端所需的短暫結果。
...
| Webhook | 原始體簽名驗證、重播控制、冪性儲存及重試安全處理。 |
...
<Card title="網鉤與冪性" icon="fa-duotone fa-webhook" href="/zh-TW/sdk/security/webhooks-idempotency">
安全處理事件。
</Card>
</CardGroup>
