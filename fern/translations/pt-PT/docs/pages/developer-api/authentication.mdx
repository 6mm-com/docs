...
canonical-url: https://docs.6mm.com/pt-PT/developer-api/authentication
---
...
<CardGroup cols={3}>
<Card title="API Key Gestão" icon="fa-duotone fa-key" href="/pt-PT/developer-api/api-key-management">
...
<Card title="Erros e Resolução de Problemas" icon="fa-duotone fa-screwdriver-wrench" href="/pt-PT/developer-api/error-codes-and-troubleshooting">
