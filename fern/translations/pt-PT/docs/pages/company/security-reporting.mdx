...
canonical-url: https://docs.6mm.com/pt-PT/resources/support/security-reporting
---
...
Problemas gerais de integração devem usar o [Support Request Template](/pt-PT/resources/support-request-template). Os investigadores devem também rever o [Programa de Recompensa por Insetos](/pt-PT/security-compliance/bug-bounty-program) quanto ao âmbito e às expectativas de divulgação responsável.
