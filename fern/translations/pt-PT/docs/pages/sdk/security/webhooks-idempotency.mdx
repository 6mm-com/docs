...
canonical-url: https://docs.6mm.com/pt-PT/sdk/security/webhooks-idempotency
---
...
<CardGroup cols={3}>
<Card title="Segredos e HMAC Assinaturas" icon="fa-duotone fa-shield-keyhole" href="/pt-PT/sdk/security/secrets-signing">
