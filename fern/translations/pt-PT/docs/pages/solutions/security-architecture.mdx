...
canonical-url: https://docs.6mm.com/pt-PT/solutions/security-architecture
---
...
<CardGroup cols={3}>
<Card title="Segredos e Assinatura" icon="fa-duotone fa-key" href="/pt-PT/sdk/security/secrets-signing">
...
<Card title="Webhook & Idempotência" icon="fa-duotone fa-webhook" href="/pt-PT/sdk/security/webhooks-idempotency">
