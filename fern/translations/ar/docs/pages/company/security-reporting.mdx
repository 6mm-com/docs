...
يجب أن تستخدم مشاكل التكامل العامة [قالب طلب الدعم](/ar/resources/support-request-template). يجب على الباحثين أيضا مراجعة [برنامج مكافآت اكتشاف الثغرات](/ar/security-compliance/bug-bounty-program) لمعرفة نطاق وتوقعات الإفصاح المسؤول.
