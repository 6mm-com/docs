...
Frontend đối tác nên gọi backend đối tác để thực hiện các thao tác đặc quyền. Backend xác thực người dùng đối tác, gọi 6MM qua API hoặc SDKđược phê duyệt, và chỉ trả về kết quả ngắn hạn mà frontend cần.
