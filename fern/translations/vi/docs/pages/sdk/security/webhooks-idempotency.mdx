...
Sử dụng chính xác phần thân yêu cầu thô nhận được trên HTTP khi tái tạo giá trị đã ký. Phân tích cú pháp và tuần tự hóa lại JSON trước có thể thay đổi khoảng trắng hoặc thứ tự trường và tạo ra một chữ ký khác.
...
<h2 id="order-idempotency">Tính đồng nhất của thứ tự</h2>
...
Cam kết bản ghi thay đổi kinh doanh và bản ghi idempotency trong cùng một giao dịch nếu có thể. Một sự kiện lặp lại nên trả về kết quả đã biết thay vì áp dụng lại số dư, thứ tự hoặc thay đổi người dùng.
