...
slug: pt/sdk/security/secrets-signing
canonical-url: https://docs.6mm.com/pt/sdk/security/secrets-signing
---
...
>
> Agent SDK assinatura utiliza campos de pedido ordenados, um carimbo temporal baseado em segundos e um nonce. Os pedidos de API do Desenvolvedor Direto utilizam o processo separado descrito em [Request Signing](/pt/developer-api/request-signing). Não reutilize um formato de carga útil para o outro.
