...
canonical-url: https://docs.6mm.com/zh-CN/sdk/trading-widget/quick-start
---
...
<CardGroup cols={3}>
<Card title="Widget 鉴权" icon="fa-duotone fa-user-shield" href="/zh-CN/sdk/trading-widget/authentication">
将嵌入式交易终端连接到已授权用户会话。
</Card>
<Card title="参数与事件" icon="fa-duotone fa-sliders" href="/zh-CN/sdk/trading-widget/options-events">
配置交易对、语言、显示方式和生命周期回调。
</Card>
<Card title="实例方法" icon="fa-duotone fa-code" href="/zh-CN/sdk/trading-widget/instance-methods">
初始化完成后控制 Widget 实例。
</Card>
</CardGroup>
