---
title: "Trading Widget 身份认证"
subtitle: "新接入建议使用 partner-token 模式。"
slug: sdk/trading-widget/authentication
canonical-url: https://docs.6mm.com/zh-CN/sdk/trading-widget/authentication
---
...
- [创建 Embed Token](/zh-CN/sdk/agent-sdk/java/embed-token)：后端 Token 签发示例。
- [Trading Widget 快速开始](/zh-CN/sdk/trading-widget/quick-start)：完整初始化流程。
- [密钥与签名](/zh-CN/sdk/security/secrets-signing)：把高权限 Agent 凭据保存在后端。
- [故障排查](/zh-CN/sdk/security/troubleshooting)：诊断登录态、Token、域名和初始化失败。
