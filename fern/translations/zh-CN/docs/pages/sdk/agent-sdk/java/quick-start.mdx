...
canonical-url: https://docs.6mm.com/zh-CN/sdk/agent-sdk/java/quick-start
---

<h2 id="install">安装</h2>

公开 SDK 源码当前使用 `v0.1.1` 标签，对应 Maven 坐标如下：
...
GitHub 不是 Maven 依赖仓库。引用依赖前，先在本地安装对应标签的源码：
...
> **团队构建**
>
> CI、测试和生产构建应把确认后的构件发布到组织内部 Maven 仓库。生产上线前向 6MM 确认批准使用的版本。
...
| 需求 | 下一页 |
| --- | --- |
| 签发 Trading Widget 凭据 | [创建 Embed Token](/zh-CN/sdk/agent-sdk/java/embed-token) |
| 验证 6MM 回调 | [Webhook 与幂等](/zh-CN/sdk/security/webhooks-idempotency) |
| 查看签名行为 | [密钥与签名](/zh-CN/sdk/security/secrets-signing) |
| 排查接入问题 | [SDK 故障排查](/zh-CN/sdk/security/troubleshooting) |
