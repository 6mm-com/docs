...
canonical-url: https://docs.6mm.com/zh-CN/sdk/security/webhooks-idempotency
---
...
<CardGroup cols={3}>
<Card title="密钥与 HMAC 签名" icon="fa-duotone fa-shield-keyhole" href="/zh-CN/sdk/security/secrets-signing">
保护请求和 Webhook 验证使用的 API Secret。
</Card>
<Card title="Agent SDK 概览" icon="fa-duotone fa-server" href="/zh-CN/sdk/agent-sdk/overview">
查看完整的后端接入流程。
</Card>
<Card title="SDK 接入排查" icon="fa-duotone fa-screwdriver-wrench" href="/zh-CN/sdk/security/troubleshooting">
排查签名失败、重复事件和待确认操作。
</Card>
</CardGroup>
