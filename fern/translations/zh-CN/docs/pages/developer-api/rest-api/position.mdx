---
title: "仓位"
description: "使用 6MM 仓位接口查询当前持仓、保证金、杠杆、未实现盈亏和仓位相关操作信息。"
slug: developer-api/rest-api/position
canonical-url: https://docs.6mm.com/zh-CN/developer-api/rest-api/position
---
...
- [保证金规则](/zh-CN/trading/margin-rules)
- [杠杆机制](/zh-CN/trading/leverage-mechanics)
- [风险与强制平仓](/zh-CN/trading/risk-and-liquidations)
