---
title: "订单"
description: "使用 6MM 订单接口创建、查询、撤销和管理永续合约订单，并处理权限、标识符和订单生命周期状态。"
slug: developer-api/rest-api/order
canonical-url: https://docs.6mm.com/zh-CN/developer-api/rest-api/order
---
...
- [订单类型](/zh-CN/trading/order-types)
- [常用枚举](/zh-CN/developer-api/common-enums)
- [私有用户频道](/zh-CN/developer-api/websocket/private-user-channel)
