---
title: "公开接口"
description: "访问 6MM 公开 API，获取交易品种、行情、订单簿、成交及其他无需鉴权的市场信息。"
slug: developer-api/rest-api/public-endpoints
canonical-url: https://docs.6mm.com/zh-CN/developer-api/rest-api/public-endpoints
---
...
- [公共 WebSocket 行情频道](/zh-CN/developer-api/websocket/public-market-channels)
- [环境与通用约定](/zh-CN/developer-api/environments-and-common-conventions)
