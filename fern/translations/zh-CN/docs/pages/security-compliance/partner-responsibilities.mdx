...
canonical-url: https://docs.6mm.com/zh-CN/security-compliance/partner-responsibilities
---
...
<CardGroup cols={3}>
<Card title="接入安全架构" icon="fa-duotone fa-shield-keyhole" href="/zh-CN/solutions/security-architecture">
设计合作方侧信任边界和安全控制。
</Card>
<Card title="合规接入说明" icon="fa-duotone fa-scale-balanced" href="/zh-CN/security-compliance/compliance-overview">
了解合规准备和运营边界。
</Card>
<Card title="生产上线检查" icon="fa-duotone fa-list-check" href="/zh-CN/solutions/production-launch-checklist">
上线前确认技术和运营准备情况。
</Card>
</CardGroup>
