...
slug: es/sdk/trading-widget/quick-start
canonical-url: https://docs.6mm.com/es/sdk/trading-widget/quick-start
---
...
- Planificar el [flujo de autenticación](/es/sdk/trading-widget/authentication) antes de habilitar funciones de cuenta o trading en producción.
...
<CardGroup cols={3}>
<Card title="Autenticación de widgets" icon="fa-duotone fa-user-shield" href="/es/sdk/trading-widget/authentication">
Conecta el terminal embebido a una sesión de usuario aprobada.
</Card>
<Card title="Opciones y eventos" icon="fa-duotone fa-sliders" href="/es/sdk/trading-widget/options-events">
Configura símbolos, ubicación, comportamiento de visualización y llamadas al ciclo de vida.
</Card>
<Card title="Métodos de instancia" icon="fa-duotone fa-code" href="/es/sdk/trading-widget/instance-methods">
