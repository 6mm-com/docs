...
slug: es/sdk/security/secrets-signing
canonical-url: https://docs.6mm.com/es/sdk/security/secrets-signing
---
...
>
> Agent SDK firma utiliza campos de solicitud ordenados, una marca de tiempo basada en segundos y un nonce. Las solicitudes de API del Desarrollador Directo utilizan el proceso separado descrito en [Solicitud de Firma](/es/developer-api/request-signing). No reutilices un formato de carga útil para el otro.
...
<CardGroup cols={3}>
<Card title="Agent SDK Resumen" icon="fa-duotone fa-server" href="/es/sdk/agent-sdk/overview">
...
<Card title="SDK Resolución de problemas" icon="fa-duotone fa-screwdriver-wrench" href="/es/sdk/security/troubleshooting">
