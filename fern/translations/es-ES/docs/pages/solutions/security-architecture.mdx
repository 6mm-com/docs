...
canonical-url: https://docs.6mm.com/es-ES/solutions/security-architecture
---
...
<CardGroup cols={3}>
<Card title="Secretos y firma" icon="fa-duotone fa-key" href="/es-ES/sdk/security/secrets-signing">
...
<Card title="Webhook e Idempotencia" icon="fa-duotone fa-webhook" href="/es-ES/sdk/security/webhooks-idempotency">
