...
canonical-url: https://docs.6mm.com/es-ES/security-compliance/security-policies
---
...
- [Arquitectura de Seguridad de Plataforma](/es-ES/security-compliance/security-architecture)
