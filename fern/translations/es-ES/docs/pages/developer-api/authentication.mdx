...
canonical-url: https://docs.6mm.com/es-ES/developer-api/authentication
---
...
API Key solicitudes también requieren la marca de tiempo y HMAC firma descrita en [Request Signing](/es-ES/developer-api/request-signing). Almacenar el secreto API correspondiente solo en un sistema de gestión de secretos en backend.
...
<CardGroup cols={3}>
<Card title="API Key Gestión" icon="fa-duotone fa-key" href="/es-ES/developer-api/api-key-management">
...
<Card title="Errores y solución de problemas" icon="fa-duotone fa-screwdriver-wrench" href="/es-ES/developer-api/error-codes-and-troubleshooting">
