...
canonical-url: https://docs.6mm.com/es-ES/sdk/security/webhooks-idempotency
---
...
<CardGroup cols={3}>
<Card title="Secretos y HMAC firmas" icon="fa-duotone fa-shield-keyhole" href="/es-ES/sdk/security/secrets-signing">
Protege el API secreto utilizado para la verificación de solicitudes y webhooks.
</Card>
<Card title="Agent SDK Resumen" icon="fa-duotone fa-server" href="/es-ES/sdk/agent-sdk/overview">
Revisa todo el flujo de trabajo de integración del backend.
</Card>
<Card title="SDK Resolución de problemas" icon="fa-duotone fa-screwdriver-wrench" href="/es-ES/sdk/security/troubleshooting">
