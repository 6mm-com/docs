...
canonical-url: https://docs.6mm.com/zh/developer-api/rest-api/user-and-account
---
...
- [私有用户频道](/zh/developer-api/websocket/private-user-channel)：使用 listenKey 接收订单、仓位和余额事件。
- [身份认证](/zh/developer-api/authentication)：选择 JWT 或 API Key 签名方式。
- [错误码与故障排查](/zh/developer-api/error-codes-and-troubleshooting)：处理鉴权、参数和服务端错误。
