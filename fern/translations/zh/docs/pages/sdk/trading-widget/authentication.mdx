...
canonical-url: https://docs.6mm.com/zh/sdk/trading-widget/authentication
---
...
- [创建 Embed Token](/zh/sdk/agent-sdk/java/embed-token)：后端 Token 签发示例。
- [Trading Widget 快速开始](/zh/sdk/trading-widget/quick-start)：完整初始化流程。
- [密钥与签名](/zh/sdk/security/secrets-signing)：把高权限 Agent 凭据保存在后端。
- [故障排查](/zh/sdk/security/troubleshooting)：诊断登录态、Token、域名和初始化失败。
