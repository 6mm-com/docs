...
canonical-url: https://docs.6mm.com/zh/sdk/agent-sdk/php/quick-start
---
...
| 需求 | 下一页 |
| --- | --- |
| 了解 Agent SDK 能力 | [Agent SDK 概览](/zh/sdk/agent-sdk/overview) |
| 查看签名行为 | [密钥与签名](/zh/sdk/security/secrets-signing) |
| 验证回调投递 | [Webhook 与幂等](/zh/sdk/security/webhooks-idempotency) |
