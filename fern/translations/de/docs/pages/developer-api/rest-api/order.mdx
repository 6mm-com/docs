---
title: "Bestellung"
description: "Verwenden Sie 6MM Order-Endpunkte, um dauerhafte Bestellungen zu erstellen, abzufragen, zu stornieren und zu verwalten, während sie Berechtigungen, Identifikatoren und Lebenszykluszustände verwalten."
...
| `price`         | string | Bedingt erforderlich | Erforderlich für Limit-Bestellungen                                                                                                     |
...
| `placeType`     | string | Nein                     | Ordnungsplatzierungs-Typmarker                                                                                                   |
...
<h2 id="batch-place-orders">Chargenbestellungen</h2>
...
| Spielfeld          | Typ  | Beschreibung                 |
| -------------- | ----- | --------------------------- |
| `successCount` | int32 | Anzahl erfolgreicher Bestellungen |
| `failedCount`  | int32 | Anzahl fehlgeschlagener Aufträge     |
| `results[]`    | array | Ergebnis für jede Ordnung       |
...
| `callbackRate`  | string | Bedingt erforderlich | Rückruf-Rate für nachfolgende Bestellungen                                                                |
...
| `type`          | int32  | Nein       | Bestelltyp-Filter: `1` Grenze, `2` Markt |
...
<h2 id="cancel-order">Bestellung stornieren</h2>
...
`clientOrderId` kann auch verwendet werden, um eine Bestellung zu stornieren.
...
`quantity` ist die endgültige Gesamtbestellungsmenge nach der Änderung, nicht die verbleibende Menge.
...
<h2 id="batch-cancel-orders">Bestellungen in Chargen stornieren</h2>
...
Stornieren-alle für normale Bestellungen wird asynchron akzeptiert. Der Endstatus sollte durch WebSocket `ORDER_TRADE_UPDATE` - oder Abfrage-Endpunkte bestimmt werden.
