...
canonical-url: https://docs.6mm.com/en-142/trading/order-types
---
...
- [Take Profit / Stop Loss](/en-142/trading/take-profit-stop-loss): conditional exit behavior.
- [Fees & Slippage](/en-142/trading/fees-and-slippage): how order choice changes execution cost.
- [Order API](/en-142/developer-api/rest-api/order): create, query, amend, and cancel orders programmatically.
- [Common Enums](/en-142/developer-api/common-enums): wire values for order type, side, status, and time in force.
