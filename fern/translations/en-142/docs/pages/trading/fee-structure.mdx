...
canonical-url: https://docs.6mm.com/en-142/trading/fee-structure
---
...
This page is the reference for fee categories and settlement. To understand how order-book depth and execution price affect total trading cost, see [Trading Costs: Fees & Slippage](/en-142/trading/fees-and-slippage).
...
- [Fees & Slippage](/en-142/trading/fees-and-slippage): estimate total execution cost.
- [Perpetual Contracts](/en-142/trading/perpetual-contracts): understand funding and settlement.
- [Institutional Liquidity](/en-142/solutions/institutional-liquidity): review the role of market depth and spreads.
