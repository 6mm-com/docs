...
canonical-url: https://docs.6mm.com/en-142/resources/integration-information-template
---
...
Use the [production launch checklist](/en-142/resources/production-launch-checklist) for final approval and the [support request template](/en-142/resources/support-request-template) for issue escalation.
