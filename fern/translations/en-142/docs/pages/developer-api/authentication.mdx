...
canonical-url: https://docs.6mm.com/en-142/developer-api/authentication
---
...
API Key requests also require the timestamp and HMAC signature described in [Request Signing](/en-142/developer-api/request-signing). Store the corresponding API secret only in a backend secret-management system.
...
<CardGroup cols={3}>
<Card title="API Key Management" icon="fa-duotone fa-key" href="/en-142/developer-api/api-key-management">
...
<Card title="Errors & Troubleshooting" icon="fa-duotone fa-screwdriver-wrench" href="/en-142/developer-api/error-codes-and-troubleshooting">
