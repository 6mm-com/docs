...
canonical-url: https://docs.6mm.com/en-142/developer-api/websocket
---
...
- [Connection, Subscription & Heartbeat](/en-142/developer-api/websocket/connection-subscription-and-heartbeat): connection lifecycle, ping, reconnect, and resubscription.
- [Public Market Channels](/en-142/developer-api/websocket/public-market-channels): depth, trades, Klines, tickers, and sequence handling.
- [Private User Channel](/en-142/developer-api/websocket/private-user-channel): listenKey lifecycle and authenticated account events.
- [Integration Recommendations](/en-142/developer-api/integration-recommendations): monitoring, idempotency, retries, and production testing.
