...
canonical-url: https://docs.6mm.com/en-142/developer-api/websocket/connection-subscription-and-heartbeat
---
...
- [Public Market Channels](/en-142/developer-api/websocket/public-market-channels): topics, order-book continuity, trades, candles, and tickers.
- [Private User Channel](/en-142/developer-api/websocket/private-user-channel): listenKey lifecycle and authenticated events.
- [Integration Recommendations](/en-142/developer-api/integration-recommendations): retries, idempotency, monitoring, and launch testing.
