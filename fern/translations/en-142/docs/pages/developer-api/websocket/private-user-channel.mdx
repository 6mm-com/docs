...
canonical-url: https://docs.6mm.com/en-142/developer-api/websocket/private-user-channel
---
...
- If events may have been missed, query [orders](/en-142/developer-api/rest-api/order), [positions](/en-142/developer-api/rest-api/position), and [account state](/en-142/developer-api/rest-api/user-and-account) through REST.
- Follow the [connection and heartbeat guide](/en-142/developer-api/websocket/connection-subscription-and-heartbeat) for retry and stale-connection handling.
