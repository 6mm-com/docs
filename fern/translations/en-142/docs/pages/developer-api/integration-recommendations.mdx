...
canonical-url: https://docs.6mm.com/en-142/developer-api/integration-recommendations
---
...
- Prefer [API Key signing](/en-142/developer-api/authentication) for server-side trading programs and JWT for user-driven frontend actions.
...
- Determine final state after cancel, cancel-all, or amend operations from [private WebSocket events](/en-142/developer-api/websocket/private-user-channel) or a REST query.
...
- Complete the [production launch checklist](/en-142/resources/production-launch-checklist) and use the [support request template](/en-142/resources/support-request-template) when escalation is required.
