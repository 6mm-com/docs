...
canonical-url: https://docs.6mm.com/en-142/trading/getting-started/authentication
---
...
- [Developer API Authentication](/en-142/developer-api/authentication): JWT and API Key authentication for integrations.
- [Trading Widget Authentication](/en-142/sdk/trading-widget/authentication): partner-token and compatibility modes.
- [Agent SDK Overview](/en-142/sdk/agent-sdk/overview): backend user binding and credential issuance.
- [Architecture & Responsibilities](/en-142/solutions/architecture-responsibilities): partner and 6MM ownership boundaries.
