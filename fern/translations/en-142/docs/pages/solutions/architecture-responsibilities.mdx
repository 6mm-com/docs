...
canonical-url: https://docs.6mm.com/en-142/solutions/architecture-responsibilities
---
...
<CardGroup cols={3}>
<Card title="Authentication" icon="fa-duotone fa-user-shield" href="/en-142/developer-api/authentication">
...
<Card title="Webhook Security" icon="fa-duotone fa-webhook" href="/en-142/sdk/security/webhooks-idempotency">
