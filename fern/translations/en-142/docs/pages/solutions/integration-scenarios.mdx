...
canonical-url: https://docs.6mm.com/en-142/solutions/integration-scenarios
---
...
<CardGroup cols={3}>
<Card title="Architecture & Responsibilities" icon="fa-duotone fa-sitemap" href="/en-142/solutions/architecture-responsibilities">
Clarify system boundaries before development.
</Card>
<Card title="Trading Widget SDK" icon="fa-duotone fa-chart-line" href="/en-142/sdk/trading-widget/quick-start">
