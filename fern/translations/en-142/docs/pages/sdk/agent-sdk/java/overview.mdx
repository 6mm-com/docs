...
canonical-url: https://docs.6mm.com/en-142/sdk/agent-sdk/java/overview
---
...
- [Java Quick Start](/en-142/sdk/agent-sdk/java/quick-start): install the tagged source and initialize `AgentClient`.
- [Create Embed Token](/en-142/sdk/agent-sdk/java/embed-token): issue short-lived credentials for Trading Widget.
- [Secrets & Signing](/en-142/sdk/security/secrets-signing): understand automatic HMAC signing and secret handling.
- [Webhooks & Idempotency](/en-142/sdk/security/webhooks-idempotency): verify callbacks and prevent duplicate processing.
