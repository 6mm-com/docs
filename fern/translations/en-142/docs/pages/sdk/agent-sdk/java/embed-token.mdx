...
canonical-url: https://docs.6mm.com/en-142/sdk/agent-sdk/java/embed-token
---
...
- [Trading Widget Authentication](/en-142/sdk/trading-widget/authentication): connect `tokenProvider` to the partner endpoint.
- [Java Quick Start](/en-142/sdk/agent-sdk/java/quick-start): install and initialize `AgentClient`.
- [Secrets & Signing](/en-142/sdk/security/secrets-signing): protect the Agent API secret.
- [Webhooks & Idempotency](/en-142/sdk/security/webhooks-idempotency): secure the callback side of the integration.
