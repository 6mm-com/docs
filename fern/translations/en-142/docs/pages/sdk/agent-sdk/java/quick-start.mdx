...
canonical-url: https://docs.6mm.com/en-142/sdk/agent-sdk/java/quick-start
---
...
| Need | Next page |
| --- | --- |
| Issue a Trading Widget credential | [Create Embed Token](/en-142/sdk/agent-sdk/java/embed-token) |
| Verify callbacks from 6MM | [Webhooks & Idempotency](/en-142/sdk/security/webhooks-idempotency) |
| Review signing behavior | [Secrets & Signing](/en-142/sdk/security/secrets-signing) |
| Diagnose an integration problem | [SDK Troubleshooting](/en-142/sdk/security/troubleshooting) |
