...
canonical-url: https://docs.6mm.com/en-142/sdk/agent-sdk/overview
---
...
| --- | --- |
| Java | [Java SDK Overview](/en-142/sdk/agent-sdk/java/overview) and [Java Quick Start](/en-142/sdk/agent-sdk/java/quick-start) |
| PHP | [PHP SDK Overview](/en-142/sdk/agent-sdk/php/overview) and [PHP Quick Start](/en-142/sdk/agent-sdk/php/quick-start) |
...
<CardGroup cols={3}>
<Card title="Java Quick Start" icon="fa-brands fa-java" href="/en-142/sdk/agent-sdk/java/quick-start">
Install and initialize the Agent SDK in a Java backend.
</Card>
<Card title="PHP Quick Start" icon="fa-brands fa-php" href="/en-142/sdk/agent-sdk/php/quick-start">
