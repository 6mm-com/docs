...
canonical-url: https://docs.6mm.com/en-142/sdk/agent-sdk/php/quick-start
---
...
| Need | Next page |
| --- | --- |
| Understand Agent SDK capabilities | [Agent SDK Overview](/en-142/sdk/agent-sdk/overview) |
| Review signing behavior | [Secrets & Signing](/en-142/sdk/security/secrets-signing) |
| Verify callback delivery | [Webhooks & Idempotency](/en-142/sdk/security/webhooks-idempotency) |
