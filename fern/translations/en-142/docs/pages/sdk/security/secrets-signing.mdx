...
canonical-url: https://docs.6mm.com/en-142/sdk/security/secrets-signing
---
...
>
> Agent SDK signing uses sorted request fields, a seconds-based timestamp, and a nonce. Direct Developer API requests use the separate process described in [Request Signing](/en-142/developer-api/request-signing). Do not reuse one payload format for the other.
...
<CardGroup cols={3}>
<Card title="Agent SDK Overview" icon="fa-duotone fa-server" href="/en-142/sdk/agent-sdk/overview">
...
<Card title="SDK Troubleshooting" icon="fa-duotone fa-screwdriver-wrench" href="/en-142/sdk/security/troubleshooting">
