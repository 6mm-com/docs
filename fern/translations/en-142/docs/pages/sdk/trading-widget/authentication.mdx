...
canonical-url: https://docs.6mm.com/en-142/sdk/trading-widget/authentication
---
...
- [Create Embed Token](/en-142/sdk/agent-sdk/java/embed-token): backend token issuance example.
- [Trading Widget Quick Start](/en-142/sdk/trading-widget/quick-start): complete initialization flow.
- [Secrets & Signing](/en-142/sdk/security/secrets-signing): keep privileged Agent credentials on the backend.
- [Troubleshooting](/en-142/sdk/security/troubleshooting): diagnose session, token, origin, and initialization failures.
