...
canonical-url: https://docs.6mm.com/en-142/sdk/trading-widget/quick-start
---
...
- Plan the [authentication flow](/en-142/sdk/trading-widget/authentication) before enabling account or trading features in production.
...
<CardGroup cols={3}>
<Card title="Widget Authentication" icon="fa-duotone fa-user-shield" href="/en-142/sdk/trading-widget/authentication">
Connect the embedded terminal to an approved user session.
</Card>
<Card title="Options & Events" icon="fa-duotone fa-sliders" href="/en-142/sdk/trading-widget/options-events">
Configure symbols, locale, display behavior, and lifecycle callbacks.
</Card>
<Card title="Instance Methods" icon="fa-duotone fa-code" href="/en-142/sdk/trading-widget/instance-methods">
