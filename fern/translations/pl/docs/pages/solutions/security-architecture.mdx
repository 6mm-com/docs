...
Partner frontend powinien wywoływać partnera backend dla uprzywilejowanych operacji. Backend waliduje użytkownika partnera, wywołuje 6MM przez zatwierdzony API lub SDKi zwraca tylko krótkotrwały wynik potrzebny frontendowi.
