...
- [Developer API Authentication](/developer-api/authentication): JWT and API Key authentication for integrations.
- [Trading Widget Authentication](/sdk/trading-widget/authentication): partner-token and compatibility modes.
- [Agent SDK Overview](/sdk/agent-sdk/overview): backend user binding and credential issuance.
- [Architecture & Responsibilities](/solutions/architecture-responsibilities): partner and 6MM ownership boundaries.
