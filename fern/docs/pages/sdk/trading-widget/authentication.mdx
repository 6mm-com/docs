...
- [Create Embed Token](/sdk/agent-sdk/java/embed-token): backend token issuance example.
- [Trading Widget Quick Start](/sdk/trading-widget/quick-start): complete initialization flow.
- [Secrets & Signing](/sdk/security/secrets-signing): keep privileged Agent credentials on the backend.
- [Troubleshooting](/sdk/security/troubleshooting): diagnose session, token, origin, and initialization failures.
