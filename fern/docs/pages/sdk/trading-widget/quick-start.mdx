...
- Plan the [authentication flow](/sdk/trading-widget/authentication) before enabling account or trading features in production.
...
<CardGroup cols={3}>
<Card title="Widget Authentication" icon="fa-duotone fa-user-shield" href="/sdk/trading-widget/authentication">
Connect the embedded terminal to an approved user session.
</Card>
<Card title="Options & Events" icon="fa-duotone fa-sliders" href="/sdk/trading-widget/options-events">
Configure symbols, locale, display behavior, and lifecycle callbacks.
</Card>
<Card title="Instance Methods" icon="fa-duotone fa-code" href="/sdk/trading-widget/instance-methods">
