...
| Need | Next page |
| --- | --- |
| Understand Agent SDK capabilities | [Agent SDK Overview](/sdk/agent-sdk/overview) |
| Review signing behavior | [Secrets & Signing](/sdk/security/secrets-signing) |
| Verify callback delivery | [Webhooks & Idempotency](/sdk/security/webhooks-idempotency) |
