---
title: "6MM Agent SDK"
headline: "6MM Agent SDK for Java & PHP Backend Integration"
description: "Learn how to use the 6MM Agent SDK in Java and PHP backend services to send signed requests, bind users, transfer assets, create entry URLs, and verify webhooks."
