...
- [Java Quick Start](/sdk/agent-sdk/java/quick-start): install the tagged source and initialize `AgentClient`.
- [Create Embed Token](/sdk/agent-sdk/java/embed-token): issue short-lived credentials for Trading Widget.
- [Secrets & Signing](/sdk/security/secrets-signing): understand automatic HMAC signing and secret handling.
- [Webhooks & Idempotency](/sdk/security/webhooks-idempotency): verify callbacks and prevent duplicate processing.
