...
- [Trading Widget Authentication](/sdk/trading-widget/authentication): connect `tokenProvider` to the partner endpoint.
- [Java Quick Start](/sdk/agent-sdk/java/quick-start): install and initialize `AgentClient`.
- [Secrets & Signing](/sdk/security/secrets-signing): protect the Agent API secret.
- [Webhooks & Idempotency](/sdk/security/webhooks-idempotency): secure the callback side of the integration.
