...
| Need | Next page |
| --- | --- |
| Issue a Trading Widget credential | [Create Embed Token](/sdk/agent-sdk/java/embed-token) |
| Verify callbacks from 6MM | [Webhooks & Idempotency](/sdk/security/webhooks-idempotency) |
| Review signing behavior | [Secrets & Signing](/sdk/security/secrets-signing) |
| Diagnose an integration problem | [SDK Troubleshooting](/sdk/security/troubleshooting) |
