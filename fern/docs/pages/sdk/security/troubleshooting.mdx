...
- Use the [Support Request Template](/resources/support-request-template) to send a complete, redacted report.
...
<Card title="Secrets & Signing" icon="fa-duotone fa-shield-keyhole" href="/sdk/security/secrets-signing">
