...
>
> Agent SDK signing uses sorted request fields, a seconds-based timestamp, and a nonce. Direct Developer API requests use the separate process described in [Request Signing](/developer-api/request-signing). Do not reuse one payload format for the other.
...
<CardGroup cols={3}>
<Card title="Agent SDK Overview" icon="fa-duotone fa-server" href="/sdk/agent-sdk/overview">
...
<Card title="SDK Troubleshooting" icon="fa-duotone fa-screwdriver-wrench" href="/sdk/security/troubleshooting">
