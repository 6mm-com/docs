...
General integration problems should use the [Support Request Template](/resources/support-request-template). Researchers should also review the [Bug Bounty Program](/security-compliance/bug-bounty-program) for scope and responsible-disclosure expectations.
