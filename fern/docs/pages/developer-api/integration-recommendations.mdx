...
- Prefer [API Key signing](/developer-api/authentication) for server-side trading programs and JWT for user-driven frontend actions.
...
- Determine final state after cancel, cancel-all, or amend operations from [private WebSocket events](/developer-api/websocket/private-user-channel) or a REST query.
...
- Complete the [production launch checklist](/resources/production-launch-checklist) and use the [support request template](/resources/support-request-template) when escalation is required.
