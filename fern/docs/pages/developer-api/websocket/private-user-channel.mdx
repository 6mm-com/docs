...
- If events may have been missed, query [orders](/developer-api/rest-api/order), [positions](/developer-api/rest-api/position), and [account state](/developer-api/rest-api/user-and-account) through REST.
- Follow the [connection and heartbeat guide](/developer-api/websocket/connection-subscription-and-heartbeat) for retry and stale-connection handling.
