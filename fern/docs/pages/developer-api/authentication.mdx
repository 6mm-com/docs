...
API Key requests also require the timestamp and HMAC signature described in [Request Signing](/developer-api/request-signing). Store the corresponding API secret only in a backend secret-management system.
...
<Card title="Errors & Troubleshooting" icon="fa-duotone fa-screwdriver-wrench" href="/developer-api/error-codes-and-troubleshooting">
