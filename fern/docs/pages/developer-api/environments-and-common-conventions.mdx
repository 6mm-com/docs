...
- [Authentication](/developer-api/authentication): choose JWT or API Key signing.
- [Request Signing](/developer-api/request-signing): construct and verify signed requests.
- [REST API](/developer-api/rest-api): apply these conventions to endpoint groups.
- [Error Codes & Troubleshooting](/developer-api/error-codes-and-troubleshooting): diagnose HTTP and business errors.
