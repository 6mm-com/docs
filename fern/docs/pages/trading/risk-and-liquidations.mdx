...
- [Margin Rules](/trading/margin-rules): margin ratios and maintenance requirements.
- [Leverage Mechanics](/trading/leverage-mechanics): how exposure amplifies gains and losses.
- [Take Profit / Stop Loss](/trading/take-profit-stop-loss): automated exits and their limitations.
- [Position API](/developer-api/rest-api/position): query position and margin state programmatically.
