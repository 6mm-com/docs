...
This page focuses on execution quality and total trading cost. For maker, taker, funding, liquidation, and settlement rules, see the [Perpetual Trading Fee Structure](/trading/fee-structure).
...
- [Fee Structure](/trading/fee-structure): maker, taker, funding, liquidation, and settlement fees.
- [Market Depth & Spread](/solutions/market-depth-spread): how liquidity affects price impact.
- [Order Types](/trading/order-types): execution behavior that changes slippage.
