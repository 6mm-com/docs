...
- [Take Profit / Stop Loss](/trading/take-profit-stop-loss): conditional exit behavior.
- [Fees & Slippage](/trading/fees-and-slippage): how order choice changes execution cost.
- [Order API](/developer-api/rest-api/order): create, query, amend, and cancel orders programmatically.
- [Common Enums](/developer-api/common-enums): wire values for order type, side, status, and time in force.
