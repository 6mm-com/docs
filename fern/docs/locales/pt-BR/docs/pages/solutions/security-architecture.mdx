...
slug: pt-BR/solutions/security-architecture
...
O frontend parceiro deve chamar o backend parceiro para operações privilegiadas. O backend valida o usuário parceiro, chama 6MM através do API aprovado ou SDKe retorna apenas o resultado de curta duração necessário pelo frontend.
