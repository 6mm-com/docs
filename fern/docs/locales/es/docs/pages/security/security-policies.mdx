...
slug: es/security-compliance/security-policies
canonical-url: https://docs.6mm.com/es/security-compliance/security-policies
---
...
- [Arquitectura de Seguridad de Plataforma](/es/security-compliance/security-architecture)
