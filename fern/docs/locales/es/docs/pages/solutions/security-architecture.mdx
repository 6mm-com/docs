...
slug: es/solutions/security-architecture
canonical-url: https://docs.6mm.com/es/solutions/security-architecture
---

Esta página se centra en cómo un socio debe diseñar una integración 6MM segura. Para las capas de seguridad más amplias utilizadas en toda la plataforma de trading, véase [Arquitectura de Seguridad de Plataforma](/es/security-compliance/security-architecture).
...
5. Completar la [Lista de Verificación de Lanzamiento en Producción](/es/solutions/production-launch-checklist).

<h2 id="recommended-docs">Médicos recomendados</h2>

<CardGroup cols={3}>
<Card title="Secretos y firma" icon="fa-duotone fa-key" href="/es/sdk/security/secrets-signing">
...
<Card title="Webhook e Idempotencia" icon="fa-duotone fa-webhook" href="/es/sdk/security/webhooks-idempotency">
