---
title: "Order"
description: "Use 6MM order endpoints to create, query, cancel, and manage perpetual orders while handling permissions, identifiers, and lifecycle states."
slug: en-Asia/developer-api/rest-api/order
canonical-url: https://docs.6mm.com/en-Asia/developer-api/rest-api/order
---
...
- [Order Types](/en-Asia/trading/order-types)
- [Common Enums](/en-Asia/developer-api/common-enums)
- [Private User Channel](/en-Asia/developer-api/websocket/private-user-channel)
- [Integration Recommendations](/en-Asia/developer-api/integration-recommendations)
