...
description: "Use 6MM user and account endpoints to retrieve profiles, balances, account state, permissions, and partner-linked account information."
slug: en-Asia/developer-api/rest-api/user-and-account
canonical-url: https://docs.6mm.com/en-Asia/developer-api/rest-api/user-and-account
---
...
- [Authentication](/en-Asia/developer-api/authentication)
- [Asset Transfer](/en-Asia/trading/getting-started/asset-transfer)
- [Error Codes & Troubleshooting](/en-Asia/developer-api/error-codes-and-troubleshooting)
