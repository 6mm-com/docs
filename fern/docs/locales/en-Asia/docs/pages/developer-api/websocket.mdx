---
title: "WebSocket"
description: "Connect to the 6MM WebSocket service for public market streams and private account events, with heartbeat and subscription guidance."
slug: en-Asia/developer-api/websocket
canonical-url: https://docs.6mm.com/en-Asia/developer-api/websocket
---
...
<h2 id="choose-the-next-guide">Choose the next guide</h2>

- [Connection, Subscription & Heartbeat](/en-Asia/developer-api/websocket/connection-subscription-and-heartbeat): connection lifecycle, ping, reconnect, and resubscription.
- [Public Market Channels](/en-Asia/developer-api/websocket/public-market-channels): depth, trades, Klines, tickers, and sequence handling.
- [Private User Channel](/en-Asia/developer-api/websocket/private-user-channel): listenKey lifecycle and authenticated account events.
- [Integration Recommendations](/en-Asia/developer-api/integration-recommendations): monitoring, idempotency, retries, and production testing.
