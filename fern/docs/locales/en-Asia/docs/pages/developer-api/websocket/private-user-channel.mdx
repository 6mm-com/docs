...
slug: en-Asia/developer-api/websocket/private-user-channel
canonical-url: https://docs.6mm.com/en-Asia/developer-api/websocket/private-user-channel
---
...
- If events may have been missed, query [orders](/en-Asia/developer-api/rest-api/order), [positions](/en-Asia/developer-api/rest-api/position), and [account state](/en-Asia/developer-api/rest-api/user-and-account) through REST.
- Follow the [connection and heartbeat guide](/en-Asia/developer-api/websocket/connection-subscription-and-heartbeat) for retry and stale-connection handling.
