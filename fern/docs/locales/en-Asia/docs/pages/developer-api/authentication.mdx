...
slug: en-Asia/developer-api/authentication
canonical-url: https://docs.6mm.com/en-Asia/developer-api/authentication
---
...
API Key requests also require the timestamp and HMAC signature described in [Request Signing](/en-Asia/developer-api/request-signing). Store the corresponding API secret only in a backend secret-management system.
...
<CardGroup cols={3}>
<Card title="API Key Management" icon="fa-duotone fa-key" href="/en-Asia/developer-api/api-key-management">
...
<Card title="Errors & Troubleshooting" icon="fa-duotone fa-screwdriver-wrench" href="/en-Asia/developer-api/error-codes-and-troubleshooting">
