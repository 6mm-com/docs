...
slug: en-Asia/sdk/overview
canonical-url: https://docs.6mm.com/en-Asia/sdk/overview
---

<h2 id="choose-an-sdk-path">Choose an SDK path</h2>

<CardGroup cols={3}>
<Card title="Trading Widget SDK" icon="duotone chart-line" href="/en-Asia/sdk/trading-widget/quick-start">
  Embed the 6MM trading terminal into an existing website, wallet, broker portal, or partner product surface.
</Card>
<Card title="Agent SDK" icon="duotone server" href="/en-Asia/sdk/agent-sdk/overview">
  Connect a partner backend to 6MM for user binding, embed tokens, entry URLs, transfers, order queries, and webhooks.
</Card>
<Card title="Security & Operations" icon="duotone shield-check" href="/en-Asia/sdk/security/secrets-signing">
