...
slug: en-Asia/sdk/agent-sdk/java/embed-token
canonical-url: https://docs.6mm.com/en-Asia/sdk/agent-sdk/java/embed-token
---
...
- [Trading Widget Authentication](/en-Asia/sdk/trading-widget/authentication): connect `tokenProvider` to the partner endpoint.
- [Java Quick Start](/en-Asia/sdk/agent-sdk/java/quick-start): install and initialize `AgentClient`.
- [Secrets & Signing](/en-Asia/sdk/security/secrets-signing): protect the Agent API secret.
- [Webhooks & Idempotency](/en-Asia/sdk/security/webhooks-idempotency): secure the callback side of the integration.
