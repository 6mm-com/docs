...
slug: en-Asia/sdk/agent-sdk/php/quick-start
canonical-url: https://docs.6mm.com/en-Asia/sdk/agent-sdk/php/quick-start
---
...
| Need | Next page |
| --- | --- |
| Understand Agent SDK capabilities | [Agent SDK Overview](/en-Asia/sdk/agent-sdk/overview) |
| Review signing behavior | [Secrets & Signing](/en-Asia/sdk/security/secrets-signing) |
| Verify callback delivery | [Webhooks & Idempotency](/en-Asia/sdk/security/webhooks-idempotency) |
