...
slug: en-Asia/sdk/agent-sdk/java/quick-start
canonical-url: https://docs.6mm.com/en-Asia/sdk/agent-sdk/java/quick-start
---
...
| Need | Next page |
| --- | --- |
| Issue a Trading Widget credential | [Create Embed Token](/en-Asia/sdk/agent-sdk/java/embed-token) |
| Verify callbacks from 6MM | [Webhooks & Idempotency](/en-Asia/sdk/security/webhooks-idempotency) |
| Review signing behavior | [Secrets & Signing](/en-Asia/sdk/security/secrets-signing) |
| Diagnose an integration problem | [SDK Troubleshooting](/en-Asia/sdk/security/troubleshooting) |
