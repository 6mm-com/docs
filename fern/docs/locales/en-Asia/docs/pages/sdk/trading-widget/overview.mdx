...
slug: en-Asia/sdk/trading-widget/overview
canonical-url: https://docs.6mm.com/en-Asia/sdk/trading-widget/overview
---
...
1. Follow the [Trading Widget Quick Start](/en-Asia/sdk/trading-widget/quick-start) to load the script and create a visible container.
2. Configure [partner-token authentication](/en-Asia/sdk/trading-widget/authentication) through a partner backend.
3. Add the required [options and events](/en-Asia/sdk/trading-widget/options-events).
4. Use [instance methods](/en-Asia/sdk/trading-widget/instance-methods) for lifecycle and runtime controls.
