---
title: "Trading Widget Authentication"
subtitle: "Use partner-token for new embedded trading SSO integrations."
slug: en-Asia/sdk/trading-widget/authentication
canonical-url: https://docs.6mm.com/en-Asia/sdk/trading-widget/authentication
---
...
- [Create Embed Token](/en-Asia/sdk/agent-sdk/java/embed-token): backend token issuance example.
- [Trading Widget Quick Start](/en-Asia/sdk/trading-widget/quick-start): complete initialization flow.
- [Secrets & Signing](/en-Asia/sdk/security/secrets-signing): keep privileged Agent credentials on the backend.
- [Troubleshooting](/en-Asia/sdk/security/troubleshooting): diagnose session, token, origin, and initialization failures.
