...
slug: en-Asia/resources/integration-information-template
canonical-url: https://docs.6mm.com/en-Asia/resources/integration-information-template
---
...
<h2 id="security-and-review-information">Security and review information</h2>
...
Use the [production launch checklist](/en-Asia/resources/production-launch-checklist) for final approval and the [support request template](/en-Asia/resources/support-request-template) for issue escalation.
