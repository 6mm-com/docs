...
slug: en-Asia/solutions/institutional-liquidity
canonical-url: https://docs.6mm.com/en-Asia/solutions/institutional-liquidity
---
...
<CardGroup cols={3}>
<Card title="6 Market Maker" icon="fa-duotone fa-rocket-launch" href="/en-Asia/solutions/6-market-maker">
Understand 6MM as a liquidity and market making infrastructure layer.
</Card>
<Card title="Fees & Slippage" icon="fa-duotone fa-hand-holding-dollar" href="/en-Asia/trading/fees-and-slippage">
Learn how market depth affects execution cost.
</Card>
<Card title="Risk & Liquidations" icon="fa-duotone fa-triangle-exclamation" href="/en-Asia/trading/risk-and-liquidations">
