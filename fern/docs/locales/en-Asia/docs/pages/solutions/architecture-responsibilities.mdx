...
slug: en-Asia/solutions/architecture-responsibilities
canonical-url: https://docs.6mm.com/en-Asia/solutions/architecture-responsibilities
---
...
<CardGroup cols={3}>
<Card title="Authentication" icon="fa-duotone fa-user-shield" href="/en-Asia/developer-api/authentication">
...
<Card title="Webhook Security" icon="fa-duotone fa-webhook" href="/en-Asia/sdk/security/webhooks-idempotency">
