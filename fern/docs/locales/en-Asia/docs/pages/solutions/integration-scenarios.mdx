...
slug: en-Asia/solutions/integration-scenarios
canonical-url: https://docs.6mm.com/en-Asia/solutions/integration-scenarios
---
...
<CardGroup cols={3}>
<Card title="Architecture & Responsibilities" icon="fa-duotone fa-sitemap" href="/en-Asia/solutions/architecture-responsibilities">
Clarify system boundaries before development.
</Card>
<Card title="Trading Widget SDK" icon="fa-duotone fa-chart-line" href="/en-Asia/sdk/trading-widget/quick-start">
