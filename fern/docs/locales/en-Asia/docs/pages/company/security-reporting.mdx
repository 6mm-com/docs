...
slug: en-Asia/resources/support/security-reporting
canonical-url: https://docs.6mm.com/en-Asia/resources/support/security-reporting
---
...
General integration problems should use the [Support Request Template](/en-Asia/resources/support-request-template). Researchers should also review the [Bug Bounty Program](/en-Asia/security-compliance/bug-bounty-program) for scope and responsible-disclosure expectations.
