---
title: "Margin Rules"
description: "Margin is the amount of funds required to open and maintain a leveraged position."
slug: en-Asia/trading/margin-rules
canonical-url: https://docs.6mm.com/en-Asia/trading/margin-rules
---
...
- [Leverage Mechanics](/en-Asia/trading/leverage-mechanics): how exposure changes margin requirements.
- [Risk & Liquidations](/en-Asia/trading/risk-and-liquidations): what happens when maintenance requirements are not met.
- [Asset Transfer](/en-Asia/trading/getting-started/asset-transfer): how trading allocation enters and leaves the trading account.
