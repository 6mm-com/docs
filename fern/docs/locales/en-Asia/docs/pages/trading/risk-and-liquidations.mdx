...
description: "Perpetual contract trading involves leverage, which amplifies both potential gains and potential losses."
slug: en-Asia/trading/risk-and-liquidations
canonical-url: https://docs.6mm.com/en-Asia/trading/risk-and-liquidations
---
...
<h2 id="related-risk-guides">Related risk guides</h2>

- [Margin Rules](/en-Asia/trading/margin-rules): margin ratios and maintenance requirements.
- [Leverage Mechanics](/en-Asia/trading/leverage-mechanics): how exposure amplifies gains and losses.
- [Take Profit / Stop Loss](/en-Asia/trading/take-profit-stop-loss): automated exits and their limitations.
- [Position API](/en-Asia/developer-api/rest-api/position): query position and margin state programmatically.
