...
description: "Leverage allows traders to open positions that are larger than their actual capital by using borrowed funds."
slug: en-Asia/trading/leverage-mechanics
canonical-url: https://docs.6mm.com/en-Asia/trading/leverage-mechanics
---
...
- [Margin Rules](/en-Asia/trading/margin-rules): initial margin, maintenance margin, and available margin.
- [Risk & Liquidations](/en-Asia/trading/risk-and-liquidations): mark price and liquidation workflow.
- [Take Profit / Stop Loss](/en-Asia/trading/take-profit-stop-loss): automate exits around a leveraged position.
