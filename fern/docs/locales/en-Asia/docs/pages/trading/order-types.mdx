---
title: "Order Types"
description: "An order defines how and at what price you want to buy or sell a perpetual contract."
slug: en-Asia/trading/order-types
canonical-url: https://docs.6mm.com/en-Asia/trading/order-types
---
...
<h2 id="related-order-guides">Related order guides</h2>

- [Take Profit / Stop Loss](/en-Asia/trading/take-profit-stop-loss): conditional exit behavior.
- [Fees & Slippage](/en-Asia/trading/fees-and-slippage): how order choice changes execution cost.
- [Order API](/en-Asia/developer-api/rest-api/order): create, query, amend, and cancel orders programmatically.
- [Common Enums](/en-Asia/developer-api/common-enums): wire values for order type, side, status, and time in force.
