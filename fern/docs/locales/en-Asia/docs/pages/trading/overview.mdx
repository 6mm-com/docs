...
<CardGroup cols={2}>
<Card title="Start Trading" icon="fa-duotone fa-play" href="/en-Asia/trading/getting-started/start-trading">
Follow the first-trade journey from partner access to position settlement.
</Card>
<Card title="Trading Workflow" icon="fa-duotone fa-route" href="/en-Asia/trading/getting-started/trading-workflow">
Review the complete perpetual trading lifecycle.
</Card>
<Card title="Perpetual Contracts" icon="fa-duotone fa-chart-candlestick" href="/en-Asia/trading/perpetual-contracts">
Understand U-margined perpetual contracts, leverage, and funding.
</Card>
<Card title="Risk & Liquidations" icon="fa-duotone fa-shield-check" href="/en-Asia/trading/risk-and-liquidations">
