...
slug: en-Asia/trading/fee-structure
canonical-url: https://docs.6mm.com/en-Asia/trading/fee-structure
---
...
This page is the reference for fee categories and settlement. To understand how order-book depth and execution price affect total trading cost, see [Trading Costs: Fees & Slippage](/en-Asia/trading/fees-and-slippage).
...
- [Fees & Slippage](/en-Asia/trading/fees-and-slippage): estimate total execution cost.
- [Perpetual Contracts](/en-Asia/trading/perpetual-contracts): understand funding and settlement.
- [Institutional Liquidity](/en-Asia/solutions/institutional-liquidity): review the role of market depth and spreads.
