...
description: "Take Profit (TP) and Stop Loss (SL) are automated orders designed to help traders lock in profits and limit losses without constantly monitoring the market."
slug: en-Asia/trading/take-profit-stop-loss
canonical-url: https://docs.6mm.com/en-Asia/trading/take-profit-stop-loss
---
...
- [Order Types](/en-Asia/trading/order-types): supported condition-order behavior.
- [Leverage Mechanics](/en-Asia/trading/leverage-mechanics): position exposure and risk.
- [Risk & Liquidations](/en-Asia/trading/risk-and-liquidations): why TP/SL does not eliminate liquidation risk.
