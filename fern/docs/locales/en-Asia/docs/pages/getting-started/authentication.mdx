---
title: "Trading Account Access"
description: "Understand the partner-managed registration and account access model used to connect users to 6MM trading while preserving responsibility boundaries."
slug: en-Asia/trading/getting-started/authentication
canonical-url: https://docs.6mm.com/en-Asia/trading/getting-started/authentication
---
...
- [Developer API Authentication](/en-Asia/developer-api/authentication): JWT and API Key authentication for integrations.
- [Trading Widget Authentication](/en-Asia/sdk/trading-widget/authentication): partner-token and compatibility modes.
- [Agent SDK Overview](/en-Asia/sdk/agent-sdk/overview): backend user binding and credential issuance.
- [Architecture & Responsibilities](/en-Asia/solutions/architecture-responsibilities): partner and 6MM ownership boundaries.
