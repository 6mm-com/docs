...
description: "6MM supports U-margined perpetual contracts, allowing users to trade perpetual futures settled and margined in stablecoins (e.g. USDT)."
slug: en-Asia/trading/getting-started/trading-workflow
canonical-url: https://docs.6mm.com/en-Asia/trading/getting-started/trading-workflow
---
...
<h2 id="related-trading-guides">Related trading guides</h2>

- [Perpetual Contracts](/en-Asia/trading/perpetual-contracts): contract, funding, margin, and settlement basics.
- [Order Types](/en-Asia/trading/order-types): limit, market, conditional, and time-in-force behavior.
- [Fees & Slippage](/en-Asia/trading/fees-and-slippage): execution cost and liquidity impact.
- [Risk & Liquidations](/en-Asia/trading/risk-and-liquidations): margin risk and forced close behavior.
