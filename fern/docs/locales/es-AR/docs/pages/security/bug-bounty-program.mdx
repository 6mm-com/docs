...
slug: es-AR/security-compliance/bug-bounty-program
canonical-url: https://docs.6mm.com/es-AR/security-compliance/bug-bounty-program
---
...
Los siguientes generalmente quedan excluidos del Programa de Recompensas por Insectos:
...
- [Reportar una vulnerabilidad de seguridad](/es-AR/resources/support/security-reporting)
