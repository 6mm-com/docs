---
title: "Firma de solicitudes"
description: "Firmar 6MM API solicitudes con HMAC-SHA256 usando la carga útil, la marca de tiempo, la clave de API , los encabezados de firma y las reglas de verificación requeridas."
slug: es-AR/developer-api/request-signing
canonical-url: https://docs.6mm.com/es-AR/developer-api/request-signing
---

<h2 id="request-format">Formato de la solicitud</h2>
...
* Las rutas relacionadas con el orden realizan comprobaciones de repetición de firmas. Reutilizar la misma firma en un corto periodo devuelve `Signature replay detected`.
...
- [API Key Gestión](/es-AR/developer-api/api-key-management)
