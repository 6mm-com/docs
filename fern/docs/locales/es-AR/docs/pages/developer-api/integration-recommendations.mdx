...
slug: es-AR/developer-api/integration-recommendations
canonical-url: https://docs.6mm.com/es-AR/developer-api/integration-recommendations
---
...
- Prefiere [API Key firma](/es-AR/developer-api/authentication) para programas de trading en servidor y JWT para acciones de frontend impulsadas por el usuario.
...
- Determinar el estado final tras las operaciones de cancelación, cancelación total o modificación de [eventos de WebSocket privados](/es-AR/developer-api/websocket/private-user-channel) o una consulta REST .
...
- Completar la [lista de verificación de lanzamiento en producción](/es-AR/resources/production-launch-checklist) y utilizar la [plantilla de solicitud de soporte](/es-AR/resources/support-request-template) cuando sea necesaria la escalada.
