...
slug: es-AR/resources/support/security-reporting
canonical-url: https://docs.6mm.com/es-AR/resources/support/security-reporting
---
...
Los problemas generales de integración deben utilizar la [Plantilla de Solicitud de Soporte](/es-AR/resources/support-request-template). Los investigadores también deben revisar el [Programa de Recompensas por Errores](/es-AR/security-compliance/bug-bounty-program) para determinar el alcance y las expectativas de divulgación responsable.
