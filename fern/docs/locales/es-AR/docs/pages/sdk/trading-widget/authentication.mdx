...
slug: es-AR/sdk/trading-widget/authentication
canonical-url: https://docs.6mm.com/es-AR/sdk/trading-widget/authentication
---
...
- [Create Embed Token](/es-AR/sdk/agent-sdk/java/embed-token): ejemplo de emisión de token backend.
- [Trading Widget Inicio rápido](/es-AR/sdk/trading-widget/quick-start): flujo de inicialización completo.
- [Secretos y Firmas](/es-AR/sdk/security/secrets-signing): mantén las credenciales privilegiadas de Agente en el backend.
- [Solución de problemas](/es-AR/sdk/security/troubleshooting): diagnosticar fallos de sesión, token, origen e inicialización.
...
| --- | --- | --- |
| channelId | SDK -> Backend de socios | Identificador único de la sesión del widget. El backend debería pasarlo a createEmbedToken. |
