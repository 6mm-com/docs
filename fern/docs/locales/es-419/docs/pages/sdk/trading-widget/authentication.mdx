...
subtitle: "Usa partner-token para nuevas integraciones de trading SSO embebidas."
slug: es-419/sdk/trading-widget/authentication
canonical-url: https://docs.6mm.com/es-419/sdk/trading-widget/authentication
---

<h2 id="recommended-mode-partner-token">Modo recomendado: token de socio</h2>
...
<h2 id="compatibility-mode-agent-sso">Modo de compatibilidad: agente-sso</h2>
