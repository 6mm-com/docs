...
subtitle: "Agrega el terminal de trading a una página web con un contenedor, el script v1 y TradingWidget.create()."
slug: es-419/sdk/trading-widget/quick-start
canonical-url: https://docs.6mm.com/es-419/sdk/trading-widget/quick-start
---
...
<CardGroup cols={3}>
<Card title="Autenticación de widgets" icon="fa-duotone fa-user-shield" href="/es-419/sdk/trading-widget/authentication">
Conecta el terminal embebido a una sesión de usuario aprobada.
</Card>
<Card title="Opciones y Eventos" icon="fa-duotone fa-sliders" href="/es-419/sdk/trading-widget/options-events">
Configura símbolos, ubicación, comportamiento de visualización y callbacks del ciclo de vida.
</Card>
<Card title="Métodos de instancia" icon="fa-duotone fa-code" href="/es-419/sdk/trading-widget/instance-methods">
