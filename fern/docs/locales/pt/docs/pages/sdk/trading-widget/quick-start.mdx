...
slug: pt/sdk/trading-widget/quick-start
canonical-url: https://docs.6mm.com/pt/sdk/trading-widget/quick-start
---
...
- Planeie o [fluxo de autenticação](/pt/sdk/trading-widget/authentication) antes de ativar funcionalidades de conta ou negociação em produção.
...
<CardGroup cols={3}>
<Card title="Autenticação por widgets" icon="fa-duotone fa-user-shield" href="/pt/sdk/trading-widget/authentication">
Ligue o terminal embutido a uma sessão de utilizador aprovada.
</Card>
<Card title="Opções e Eventos" icon="fa-duotone fa-sliders" href="/pt/sdk/trading-widget/options-events">
Configure símbolos, localização, comportamento de exibição e callbacks do ciclo de vida.
</Card>
<Card title="Métodos de Instância" icon="fa-duotone fa-code" href="/pt/sdk/trading-widget/instance-methods">
