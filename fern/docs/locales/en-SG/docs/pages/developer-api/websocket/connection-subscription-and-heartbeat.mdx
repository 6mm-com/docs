...
slug: en-SG/developer-api/websocket/connection-subscription-and-heartbeat
canonical-url: https://docs.6mm.com/en-SG/developer-api/websocket/connection-subscription-and-heartbeat
---
...
- [Public Market Channels](/en-SG/developer-api/websocket/public-market-channels): topics, order-book continuity, trades, candles, and tickers.
- [Private User Channel](/en-SG/developer-api/websocket/private-user-channel): listenKey lifecycle and authenticated events.
- [Integration Recommendations](/en-SG/developer-api/integration-recommendations): retries, idempotency, monitoring, and launch testing.
