...
slug: en-SG/developer-api/integration-recommendations
canonical-url: https://docs.6mm.com/en-SG/developer-api/integration-recommendations
---
...
- Prefer [API Key signing](/en-SG/developer-api/authentication) for server-side trading programs and JWT for user-driven frontend actions.
...
- Determine final state after cancel, cancel-all, or amend operations from [private WebSocket events](/en-SG/developer-api/websocket/private-user-channel) or a REST query.
...
- Complete the [production launch checklist](/en-SG/resources/production-launch-checklist) and use the [support request template](/en-SG/resources/support-request-template) when escalation is required.
