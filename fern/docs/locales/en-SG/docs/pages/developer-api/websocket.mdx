...
slug: en-SG/developer-api/websocket
canonical-url: https://docs.6mm.com/en-SG/developer-api/websocket
---
...
- [Connection, Subscription & Heartbeat](/en-SG/developer-api/websocket/connection-subscription-and-heartbeat): connection lifecycle, ping, reconnect, and resubscription.
- [Public Market Channels](/en-SG/developer-api/websocket/public-market-channels): depth, trades, Klines, tickers, and sequence handling.
- [Private User Channel](/en-SG/developer-api/websocket/private-user-channel): listenKey lifecycle and authenticated account events.
- [Integration Recommendations](/en-SG/developer-api/integration-recommendations): monitoring, idempotency, retries, and production testing.
