...
slug: en-SG/trading/getting-started/authentication
canonical-url: https://docs.6mm.com/en-SG/trading/getting-started/authentication
---
...
- [Developer API Authentication](/en-SG/developer-api/authentication): JWT and API Key authentication for integrations.
- [Trading Widget Authentication](/en-SG/sdk/trading-widget/authentication): partner-token and compatibility modes.
- [Agent SDK Overview](/en-SG/sdk/agent-sdk/overview): backend user binding and credential issuance.
- [Architecture & Responsibilities](/en-SG/solutions/architecture-responsibilities): partner and 6MM ownership boundaries.
