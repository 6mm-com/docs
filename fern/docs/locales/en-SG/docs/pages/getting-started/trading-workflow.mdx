...
slug: en-SG/trading/getting-started/trading-workflow
canonical-url: https://docs.6mm.com/en-SG/trading/getting-started/trading-workflow
---
...
- [Perpetual Contracts](/en-SG/trading/perpetual-contracts): contract, funding, margin, and settlement basics.
- [Order Types](/en-SG/trading/order-types): limit, market, conditional, and time-in-force behavior.
- [Fees & Slippage](/en-SG/trading/fees-and-slippage): execution cost and liquidity impact.
- [Risk & Liquidations](/en-SG/trading/risk-and-liquidations): margin risk and forced close behavior.
