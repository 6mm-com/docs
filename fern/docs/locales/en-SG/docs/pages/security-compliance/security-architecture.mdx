...
slug: en-SG/security-compliance/security-architecture
canonical-url: https://docs.6mm.com/en-SG/security-compliance/security-architecture
---
...
- [Secrets & Signing](/en-SG/sdk/security/secrets-signing)
- [Webhooks & Idempotency](/en-SG/sdk/security/webhooks-idempotency)
