...
slug: en-SG/trading/margin-rules
canonical-url: https://docs.6mm.com/en-SG/trading/margin-rules
---
...
- [Leverage Mechanics](/en-SG/trading/leverage-mechanics): how exposure changes margin requirements.
- [Risk & Liquidations](/en-SG/trading/risk-and-liquidations): what happens when maintenance requirements are not met.
- [Asset Transfer](/en-SG/trading/getting-started/asset-transfer): how trading allocation enters and leaves the trading account.
