...
slug: en-SG/trading/order-types
canonical-url: https://docs.6mm.com/en-SG/trading/order-types
---
...
- [Take Profit / Stop Loss](/en-SG/trading/take-profit-stop-loss): conditional exit behavior.
- [Fees & Slippage](/en-SG/trading/fees-and-slippage): how order choice changes execution cost.
- [Order API](/en-SG/developer-api/rest-api/order): create, query, amend, and cancel orders programmatically.
- [Common Enums](/en-SG/developer-api/common-enums): wire values for order type, side, status, and time in force.
