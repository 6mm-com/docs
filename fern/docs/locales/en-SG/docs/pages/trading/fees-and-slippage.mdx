...
slug: en-SG/trading/fees-and-slippage
canonical-url: https://docs.6mm.com/en-SG/trading/fees-and-slippage
---
...
This page focuses on execution quality and total trading cost. For maker, taker, funding, liquidation, and settlement rules, see the [Perpetual Trading Fee Structure](/en-SG/trading/fee-structure).
...
- [Fee Structure](/en-SG/trading/fee-structure): maker, taker, funding, liquidation, and settlement fees.
- [Market Depth & Spread](/en-SG/solutions/market-depth-spread): how liquidity affects price impact.
- [Order Types](/en-SG/trading/order-types): execution behavior that changes slippage.
