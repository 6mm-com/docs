...
slug: en-SG/trading/leverage-mechanics
canonical-url: https://docs.6mm.com/en-SG/trading/leverage-mechanics
---
...
- [Margin Rules](/en-SG/trading/margin-rules): initial margin, maintenance margin, and available margin.
- [Risk & Liquidations](/en-SG/trading/risk-and-liquidations): mark price and liquidation workflow.
- [Take Profit / Stop Loss](/en-SG/trading/take-profit-stop-loss): automate exits around a leveraged position.
