...
slug: en-SG/trading/risk-and-liquidations
canonical-url: https://docs.6mm.com/en-SG/trading/risk-and-liquidations
---
...
- [Margin Rules](/en-SG/trading/margin-rules): margin ratios and maintenance requirements.
- [Leverage Mechanics](/en-SG/trading/leverage-mechanics): how exposure amplifies gains and losses.
- [Take Profit / Stop Loss](/en-SG/trading/take-profit-stop-loss): automated exits and their limitations.
- [Position API](/en-SG/developer-api/rest-api/position): query position and margin state programmatically.
