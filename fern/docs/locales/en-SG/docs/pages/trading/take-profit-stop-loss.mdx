...
slug: en-SG/trading/take-profit-stop-loss
canonical-url: https://docs.6mm.com/en-SG/trading/take-profit-stop-loss
---
...
- [Order Types](/en-SG/trading/order-types): supported condition-order behavior.
- [Leverage Mechanics](/en-SG/trading/leverage-mechanics): position exposure and risk.
- [Risk & Liquidations](/en-SG/trading/risk-and-liquidations): why TP/SL does not eliminate liquidation risk.
