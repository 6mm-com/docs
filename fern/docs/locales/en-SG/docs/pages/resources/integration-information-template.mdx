...
slug: en-SG/resources/integration-information-template
canonical-url: https://docs.6mm.com/en-SG/resources/integration-information-template
---
...
Use the [production launch checklist](/en-SG/resources/production-launch-checklist) for final approval and the [support request template](/en-SG/resources/support-request-template) for issue escalation.
