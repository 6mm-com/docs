...
slug: en-SG/sdk/agent-sdk/php/quick-start
canonical-url: https://docs.6mm.com/en-SG/sdk/agent-sdk/php/quick-start
---
...
| Need | Next page |
| --- | --- |
| Understand Agent SDK capabilities | [Agent SDK Overview](/en-SG/sdk/agent-sdk/overview) |
| Review signing behavior | [Secrets & Signing](/en-SG/sdk/security/secrets-signing) |
| Verify callback delivery | [Webhooks & Idempotency](/en-SG/sdk/security/webhooks-idempotency) |
