...
slug: en-SG/sdk/agent-sdk/overview
canonical-url: https://docs.6mm.com/en-SG/sdk/agent-sdk/overview
---
...
| --- | --- |
| Java | [Java SDK Overview](/en-SG/sdk/agent-sdk/java/overview) and [Java Quick Start](/en-SG/sdk/agent-sdk/java/quick-start) |
| PHP | [PHP SDK Overview](/en-SG/sdk/agent-sdk/php/overview) and [PHP Quick Start](/en-SG/sdk/agent-sdk/php/quick-start) |
...
<CardGroup cols={3}>
<Card title="Java Quick Start" icon="fa-brands fa-java" href="/en-SG/sdk/agent-sdk/java/quick-start">
Install and initialize the Agent SDK in a Java backend.
</Card>
<Card title="PHP Quick Start" icon="fa-brands fa-php" href="/en-SG/sdk/agent-sdk/php/quick-start">
