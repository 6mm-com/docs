...
slug: en-SG/sdk/agent-sdk/java/overview
canonical-url: https://docs.6mm.com/en-SG/sdk/agent-sdk/java/overview
---
...
- [Java Quick Start](/en-SG/sdk/agent-sdk/java/quick-start): install the tagged source and initialize `AgentClient`.
- [Create Embed Token](/en-SG/sdk/agent-sdk/java/embed-token): issue short-lived credentials for Trading Widget.
- [Secrets & Signing](/en-SG/sdk/security/secrets-signing): understand automatic HMAC signing and secret handling.
- [Webhooks & Idempotency](/en-SG/sdk/security/webhooks-idempotency): verify callbacks and prevent duplicate processing.
