...
slug: en-SG/sdk/agent-sdk/java/embed-token
canonical-url: https://docs.6mm.com/en-SG/sdk/agent-sdk/java/embed-token
---
...
- [Trading Widget Authentication](/en-SG/sdk/trading-widget/authentication): connect `tokenProvider` to the partner endpoint.
- [Java Quick Start](/en-SG/sdk/agent-sdk/java/quick-start): install and initialize `AgentClient`.
- [Secrets & Signing](/en-SG/sdk/security/secrets-signing): protect the Agent API secret.
- [Webhooks & Idempotency](/en-SG/sdk/security/webhooks-idempotency): secure the callback side of the integration.
