...
slug: en-SG/sdk/trading-widget/authentication
canonical-url: https://docs.6mm.com/en-SG/sdk/trading-widget/authentication
---
...
- [Create Embed Token](/en-SG/sdk/agent-sdk/java/embed-token): backend token issuance example.
- [Trading Widget Quick Start](/en-SG/sdk/trading-widget/quick-start): complete initialization flow.
- [Secrets & Signing](/en-SG/sdk/security/secrets-signing): keep privileged Agent credentials on the backend.
- [Troubleshooting](/en-SG/sdk/security/troubleshooting): diagnose session, token, origin, and initialization failures.
