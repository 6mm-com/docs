...
slug: en-SG/sdk/trading-widget/overview
canonical-url: https://docs.6mm.com/en-SG/sdk/trading-widget/overview
---
...
1. Follow the [Trading Widget Quick Start](/en-SG/sdk/trading-widget/quick-start) to load the script and create a visible container.
2. Configure [partner-token authentication](/en-SG/sdk/trading-widget/authentication) through a partner backend.
3. Add the required [options and events](/en-SG/sdk/trading-widget/options-events).
4. Use [instance methods](/en-SG/sdk/trading-widget/instance-methods) for lifecycle and runtime controls.
