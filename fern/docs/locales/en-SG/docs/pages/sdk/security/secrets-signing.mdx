...
slug: en-SG/sdk/security/secrets-signing
canonical-url: https://docs.6mm.com/en-SG/sdk/security/secrets-signing
---
...
>
> Agent SDK signing uses sorted request fields, a seconds-based timestamp, and a nonce. Direct Developer API requests use the separate process described in [Request Signing](/en-SG/developer-api/request-signing). Do not reuse one payload format for the other.
