...
slug: en-SG/solutions/architecture-responsibilities
canonical-url: https://docs.6mm.com/en-SG/solutions/architecture-responsibilities
---
...
<CardGroup cols={3}>
<Card title="Authentication" icon="fa-duotone fa-user-shield" href="/en-SG/developer-api/authentication">
...
<Card title="Webhook Security" icon="fa-duotone fa-webhook" href="/en-SG/sdk/security/webhooks-idempotency">
