...
slug: en-SG/resources/support/security-reporting
canonical-url: https://docs.6mm.com/en-SG/resources/support/security-reporting
---
...
General integration problems should use the [Support Request Template](/en-SG/resources/support-request-template). Researchers should also review the [Bug Bounty Program](/en-SG/security-compliance/bug-bounty-program) for scope and responsible-disclosure expectations.
